...
path_trainingset = 'parquet/dataset.parquet'
path_testset = 'parquet/testset.parquet'
...
#training_data = spark.read.parquet('/home/ubuntu/data' + path_trainingset)
#test_data = spark.read.parquet('/home/ubuntu/data' + path_trainingset)
